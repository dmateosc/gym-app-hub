...
export class WorkoutSessionController {
  ...
  @ApiResponse({
    status: 200,
    description: 'List of workout sessions for the user',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'List of completed workout sessions for the user',
  })
  async getCompletedWorkoutSessionsByUserId(@Param('userId') userId: string) {
    return this.workoutSessionService.getCompletedWorkoutSessionsByUserId(
      userId,
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Active workout session for the user',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'List of workout sessions in the date range',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'List of workout sessions for the workout plan',
  })
  async getWorkoutSessionsByWorkoutPlanId(
    @Param('workoutPlanId') workoutPlanId: string,
  ) {
    return this.workoutSessionService.getWorkoutSessionsByWorkoutPlanId(
      workoutPlanId,
    );
  }
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid input data or user already has active session',
  })
  async startWorkoutSession(
    @Body() startWorkoutSessionDto: StartWorkoutSessionDto,
  ) {
    return this.workoutSessionService.startWorkoutSession({
      workoutPlanId: startWorkoutSessionDto.workoutPlanId,
      userId: startWorkoutSessionDto.userId,
      sessionDate: startWorkoutSessionDto.date,
      startTime: startWorkoutSessionDto.startTime,
    });
  }
  ...
  async completeWorkoutSession(
    ...
    return this.workoutSessionService.completeWorkoutSession({
      id,
      endTime: completeWorkoutSessionDto.endTime,
      exercises: completeWorkoutSessionDto.exercises,
      totalCaloriesBurned: completeWorkoutSessionDto.totalCaloriesBurned,
      averageHeartRate: completeWorkoutSessionDto.averageHeartRate,
      maxHeartRate: completeWorkoutSessionDto.maxHeartRate,
      notes: completeWorkoutSessionDto.notes,
      rating: completeWorkoutSessionDto.rating,
    });
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Exercise progress updated successfully',
  })
  @ApiResponse({ status: 404, description: 'Workout session not found' })
  async updateExerciseProgress(
    ...
    return this.workoutSessionService.updateExerciseProgress({
      sessionId: id,
      exerciseId: updateExerciseProgressDto.exerciseId,
      setsCompleted: updateExerciseProgressDto.setsCompleted,
      repsCompleted: updateExerciseProgressDto.repsCompleted,
      weightUsed: updateExerciseProgressDto.weightUsed,
      durationCompleted: updateExerciseProgressDto.durationCompleted,
      restTimeTaken: updateExerciseProgressDto.restTimeTaken,
      notes: updateExerciseProgressDto.notes,
      completed: updateExerciseProgressDto.completed,
    });
  }
